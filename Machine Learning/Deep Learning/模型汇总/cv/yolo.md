...
![yolov1_1.png](assets/yolo/yolov1_1.png)
...
**目的：将$7\times7\times30$的张量变为最后的处理结构，并把低置信度和高度重合的框去掉**
 ![yolov1_3.png](assets/yolo/yolov1_3.png)
...
2. 进行后处理：
![yolov1_4.png](assets/yolo/yolov1_4.png)
     1. **将第一个类别小于threshold(阈值)的清零，并重新排序把非零张量放在前面**
     2. 
 ![yolov1_5.png](assets/yolo/yolov1_5.png)
...
![yolo_loss function.png](assets/yolo/yolo_loss%20function.png)
